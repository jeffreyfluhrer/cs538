...
def plotTest1():
  ...
  plt.figure(1)
  plt.subplot(211)  
  plt.plot(time,flow1_rate,time,flow1_meas1,time,flow1_meas2,time,flow1_meas3,time,flow1_meas4)
  plt.subplot(212)
  plt.plot(time,flow2_rate,time,flow2_meas1,time,flow2_meas2,time,flow2_meas3,time,flow2_meas4)
  plt.show()
